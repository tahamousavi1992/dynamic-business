...
{
    [DataContract]
    public class PostSaveSubTypeMessageDTO
    {
        public PostSaveSubTypeMessageDTO() { }
        public PostSaveSubTypeMessageDTO(sysBpmsEvent _event)
        {
            if (_event != null)
            {
                this.ID = _event.ID;
        ...
        [DataMember]
        public List<SubTypeMessageParamEventModel> ListParameter { get; set; }
        [DataMember]
        public string KeyStatic { get; set; }
        [DataMember]
