...
namespace DynamicBusiness.BPMS.Cartable.Controllers
{
    public class BPMSRouteMapper : IServiceRouteMapper
    {
        public void RegisterRoutes(IMapRoute mapRouteManager)
        {
            ...
            //call from client http://localhost/API/BpmsCartableApi/controllerName/actionName
            var route = mapRouteManager.MapHttpRoute("BpmsCartableApi", "default", "{controller}/{action}", new { }, new[] { "DynamicBusiness.BPMS.Cartable.Controllers" });
