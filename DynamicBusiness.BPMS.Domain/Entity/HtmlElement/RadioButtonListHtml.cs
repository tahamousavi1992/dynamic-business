...
{
    [DataContract]
    [KnownType(typeof(RadioButtonListHtml))]
    public class RadioButtonListHtml : ListItemElementBase
    {
        public RadioButtonListHtml()
        {

        }
        public RadioButtonListHtml(JObject obj, HtmlElementHelperModel _helper, Guid dynamicFormId, bool isFormReadOnly) : base(obj, _helper, dynamicFormId, isFormReadOnly)
        {
